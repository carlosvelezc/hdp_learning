...
if __name__ == "__main__":
    ...
    # El [1][1] es porque ratingTotalsAndCount es (movieID, (sumOfRatings, totalRatings)),
    # Entonces el primer [1] obtiene (sumOfRatings, totalRatings)
    # El segundo [1] sería para obtener "totalRatings"
